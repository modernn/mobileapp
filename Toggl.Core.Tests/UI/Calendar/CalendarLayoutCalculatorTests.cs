        ...
        public void CalendarEventsHaveTheirOwnColumnsToTheLeft()
        {
            var calendarItems = new[]
            {
                new CalendarItem("1", "1", CalendarItemSource.TimeEntry,
                    new DateTimeOffset(2018, 11, 21, 8, 0, 0, TimeSpan.Zero), TimeSpan.FromMinutes(90), "Item 1",
                    CalendarIconKind.None),
                new CalendarItem("2", "2", CalendarItemSource.NativeCalendar,
                ...
                new CalendarItem("4", "4", CalendarItemSource.TimeEntry,
                    ...
                    CalendarIconKind.None),
                new CalendarItem("5", "5", CalendarItemSource.ExternalCalendar,
        ...
        public void OverlapingCalendarEventsAreAlwaysToTheLeft()
        {
            var calendarItems = new[]
            {
                ...
                new CalendarItem("2", "2", CalendarItemSource.NativeCalendar,
                    ...
                    CalendarIconKind.None),
                new CalendarItem("3", "3", CalendarItemSource.ExternalCalendar,
