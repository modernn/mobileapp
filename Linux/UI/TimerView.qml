...
Rectangle {
    ...
    property bool running: runningTimeEntry
    property var runningTimeEntry: toggl.runningTimeEntry
    ...
    RowLayout {
        ...
        Text {
            ...
            text: runningTimeEntry && runningTimeEntry.Duration ? runningTimeEntry.Duration : ""
            Timer {
                running: root.running
                interval: 100
                repeat: true
                onTriggered: {
                    parent.text = runningTimeEntry.start
