...
namespace Toggl.Core.UI.ViewModels.Extensions
{
    ...
    {
        internal static async Task ssoLinkIfNeededAndNavigate<TInput, TOutput>(this ViewModel<TInput, TOutput> viewModel, ITogglApi togglApi, bool isForAccountLinking, Email ssoLinkEmail, string confirmationCode)
        {
